...
class Map extends React.Component {
  ...
  render() {
    ...
    if (!isLoaded) {
      ...
      //           {locations.ADDRESSBUILDINGNAME} | Postal Code:{" "}
      //           {locations.ADDRESSPOSTALCODE}
      //         </li>
      //       ))}
      //     </ul>
      //   </div>
