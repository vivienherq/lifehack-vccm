                    ...
                    {locations.map(location => (
                        ...
                        <div className='card'>
                            <div className="card_header" >
                                <h2>{location.NAME}</h2>
                                <p>{location.DESCRIPTION}</p>
                                <p>Address: {location.ADDRESSBUILDINGNAME}</p>
                                <p>Postal Code: {location.ADDRESSPOSTALCODE}</p>
                            </div>
                        </div>
                    ))}
